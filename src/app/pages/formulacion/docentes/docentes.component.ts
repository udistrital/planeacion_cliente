...
export class DocentesComponent implements OnInit {
  ...
  constructor() { 
    this.displayedColumns = ['docente','cantidad','sueldoBasico','primaServicios','primaNavidad','primaVacaciones','aportesPensionesPublicas',
    'aportesPensionesPrivadas','aportesSaludPrivada','aportesCesantiasPublicos','aportesCesantiasPrivados','aportesRiesgoPublicos',
    'aportesRiesgoPrivados','aportesICBF','total']
