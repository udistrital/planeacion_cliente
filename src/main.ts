...
const menu = [
  ...
  { Nombre: "Reportes", Icono: "assignment", Url: null, Opciones: [
    { Nombre: "Reporte plan de acción por unidad", Url: "pages/reportes/reporte-plan-unidad", TipoOpcion: "Menú", Opciones: null },
    { Nombre: "Reporte plan de acción anual", Url: "pages/reportes/reporte-plan-anual", TipoOpcion: "Menú", Opciones: null },
    { Nombre: "Reporte consolidado presupuestal", Url: "pages/reportes/reporte-consolidado", TipoOpcion: "Menú", Opciones: null },
  ]},
